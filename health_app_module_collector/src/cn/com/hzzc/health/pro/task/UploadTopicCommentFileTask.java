 ...
 *
 */
public class UploadTopicCommentFileTask extends
	...
	public UploadTopicCommentFileTask(Activity ctx) {
		this.context = ctx;
		pdialog = ProgressDialog.show(context, "正在分享...", "系统正在处理您的请求");
	}

	public UploadTopicCommentFileTask(Activity ctx, String requestURL) {
		this.context = ctx;
