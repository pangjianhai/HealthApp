...
import cn.com.hzzc.health.pro.task.MyFocusAsyncTask;
 ...
 *
 */
public class MainPageLayoutMeMyFocusActivity extends BaseActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.main_page_layout_me_myfocus);
	...
	private void init() {
		...
		adapter = new UserItemAdapter(MainPageLayoutMeMyFocusActivity.this,
				userList);
	...
	private void loadMoreData() {
		...
		try {
			...
			MyFocusAsyncTask task = new MyFocusAsyncTask(
					MainPageLayoutMeMyFocusActivity.this);
	...
	public void checkSomeOne(String id) {
		Intent intent = new Intent(MainPageLayoutMeMyFocusActivity.this,
