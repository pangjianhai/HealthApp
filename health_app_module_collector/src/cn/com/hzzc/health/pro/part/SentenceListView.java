...
/**
 * @toto 专门留给分享信息评论展示用的，因为嵌套问题
 * @author pang
 *
 */
public class SentenceListView extends ListView implements OnScrollListener {
	public SentenceListView(Context context) {
		super(context);
		initWithContext(context);
	}

	public SentenceListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initWithContext(context);
	}

	public SentenceListView(Context context, AttributeSet attrs, int defStyle) {
	 ...
	 * 监听器接口，监听刷新、加载事件
	 */
	private SentenceListViewListener mListViewListener;
	...
	public void setXListViewListener(SentenceListViewListener l) {
		mListViewListener = l;
	}
	 ...
	 * 实现这个借口，获取刷新和加载事件
	 */
	public interface SentenceListViewListener {
