 ...
 *
 */
public abstract class ParentTopicCommentActivity extends BaseActivity {
	...
	public void onCreate(Bundle b) {
		super.onCreate(b);
		userId = new SharedPreInto(ParentTopicCommentActivity.this)
	...
	public class GridAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			if (convertView == null) {
				convertView = new ImageView(ParentTopicCommentActivity.this);
		...
		gridview.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				ShareAddPicSingleDialog dialog = ShareAddPicSingleDialog.show(
						ParentTopicCommentActivity.this, false, true, null,
	...
	public interface AfterDelPicListener
			extends
			cn.com.hzzc.health.pro.abstracts.ParentShareInfoActivity.AfterDelPicListener {
		public int afterDelPic(int position);
	}
	...
	public void select_no_tag_alert() {
		new AlertDialog.Builder(ParentTopicCommentActivity.this)
				.setTitle("保存提示").setMessage("没有选择标签  ")
